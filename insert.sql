...
insert into books (title ,publisher) values ('Cryptonomicon',4);
insert into books (title ,publisher) values ('Deep Work',5);
insert into books (title ,publisher) values ('Atomic Habits',6);
insert into books (title ,publisher) values ('The City and The City',7);
insert into books (title ,publisher) values ('The Great War for Civilisation',8);
